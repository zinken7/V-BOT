...
class Bot:
    ...
    def send_quick_replies_message(self, recipient_id, text, reply, notification_type=NotificationType.regular):
        """Send text messages to the specified recipient.
    ...
    def send_image(self, recipient_id, image_id, notification_type=NotificationType.regular):
    ...
    def send_audio(self, recipient_id, audio_id, notification_type=NotificationType.regular):
    ...
    def send_video(self, recipient_id, video_id, notification_type=NotificationType.regular):
    ...
    def send_file(self, recipient_id, file_id, notification_type=NotificationType.regular):
