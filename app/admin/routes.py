...
from app.admin.controller import IndexView, CustomerView, WelcomeView, KeywordView, WordbookView, AssetsView, CommentDataView, SettingView, UploadView, DownloadView
